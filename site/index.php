...
?>
  ...
  <div class="row imagensGaleriaUm">
    <div class="col-3">
      <div class="image-container">
        <img src="img/galeria1.jpg" style="cursor: pointer;" class="img-fluid" alt="" onclick="window.location.href = 'https://www.instagram.com/piinicoletti';">
    ...
    <div class="col-3">
      <div class="image-container">
        <img src="img/galeria2.jpg" style="cursor: pointer;" class="img-fluid" alt="" onclick="window.location.href = 'https://www.instagram.com/piinicoletti';">
    ...
    <div class="col-3">
      <div class="image-container">
        <img src="img/galeria3.jpg" style="cursor: pointer;" class="img-fluid" alt="" onclick="window.location.href = 'https://www.instagram.com/piinicoletti';">
  ...
  <div class="row imagensGaleriaDois">
    <div class="col-3">
      <div class="image-container">
        <img src="img/galeria4.jpg" style="cursor: pointer;" class="img-fluid" alt="" onclick="window.location.href = 'https://www.instagram.com/piinicoletti';">
    ...
    <div class="col-3">
      <div class="image-container">
        <img src="img/galeria5.jpg" style="cursor: pointer;" class="img-fluid" alt="" onclick="window.location.href = 'https://www.instagram.com/piinicoletti';">
